...
--
-- Structure de la table `information_users`
--

CREATE TABLE IF NOT EXISTS `information_users` (
...
--
-- Contenu de la table `info_users`
--

INSERT INTO `information_users` (`id`, `first_name`, `last_name`, `age`, `mail`, `adress`, `city`) VALUES
...
--
-- Structure de la table `service_users`
--
...
--
-- Contenu de la table `service_users`
--

INSERT INTO `service_users` (`id`, `carpool`, `car`, `model`, `type`, `num_place`, `smoker`, `animal`, `baggage`, `lodge`, `interest`, `description`) VALUES
...
(4, 1, 'peugeot', '407', 'berline', 4, 0, 0, 1, 1, 'peinture,psychologie,musique', 'je dispose de namebreuses chambre d''ami'),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `information_user_id` int(11) NOT NULL,
  `service_user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  FOREIGN KEY (information_user_id) REFERENCES information_users(id),
  FOREIGN KEY (service_user_id) REFERENCES service_users(id),
  UNIQUE KEY `information_user_id` (`information_user_id`,`service_user_id`),
  KEY `information_user_id_2` (`information_user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;
...
INSERT INTO `users` (`id`, `login`, `password`, `information_user_id`, `service_user_id`) VALUES
